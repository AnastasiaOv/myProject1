 ...
 */
@RestController
@RequestMapping(StatisticRestController.REST_URL)
public class StatisticRestController extends AbstractStatisticController {

    static final String REST_URL = "/rest/profile/statistics";
